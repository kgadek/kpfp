...
// <auto-generated>
//
// Generated from file `_LobsterDisp.java'
//
...
public abstract class _LobsterDisp extends Ice.ObjectImpl implements Lobster
{
    protected void
    ...
    move(String password, float direction, float speed)
        throws WrongPasswordException
    {
        move(password, direction, speed, null);
    }

    public static Ice.DispatchStatus
    ___move(Lobster __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        try
        {
            __obj.move(password, direction, speed, __current);
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type blackmesa::testlab::devices::Lobster was not generated with stream support";
        throw ex;
    }
