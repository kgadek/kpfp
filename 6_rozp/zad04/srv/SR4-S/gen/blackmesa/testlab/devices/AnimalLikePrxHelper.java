...
// <auto-generated>
//
// Generated from file `AnimalLikePrxHelper.java'
//
...
public final class AnimalLikePrxHelper extends Ice.ObjectPrxHelperBase implements AnimalLikePrx
{
    public void
        ...
        throws WrongPasswordException
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _AnimalLikeDel __del = (_AnimalLikeDel)__delBase;
    ...
    public static AnimalLikePrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        AnimalLikePrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (AnimalLikePrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    AnimalLikePrxHelper __h = new AnimalLikePrxHelper();
    ...
    __createDelegateM()
    {
        return new _AnimalLikeDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _AnimalLikeDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, AnimalLikePrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            AnimalLikePrxHelper result = new AnimalLikePrxHelper();
