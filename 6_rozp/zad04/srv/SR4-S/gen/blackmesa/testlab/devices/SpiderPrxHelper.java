...
// <auto-generated>
//
// Generated from file `SpiderPrxHelper.java'
//
...
public final class SpiderPrxHelper extends Ice.ObjectPrxHelperBase implements SpiderPrx
{
    public void
    growl(String password, int type)
        throws WrongPasswordException
    {
        growl(password, type, null, false);
    }
    ...
    growl(String password, int type, java.util.Map<String, String> __ctx)
        throws WrongPasswordException
    {
        growl(password, type, __ctx, true);
    }

    private void
    growl(String password, int type, java.util.Map<String, String> __ctx, boolean __explicitCtx)
        throws WrongPasswordException
    {
        ...
        while(true)
        {
            ...
            try
            {
                __checkTwowayOnly("growl");
                __delBase = __getDelegate(false);
                _SpiderDel __del = (_SpiderDel)__delBase;
                __del.growl(password, type, __ctx);
                return;
            }
    ...
    private Ice.AsyncResult begin_growl(String password, int type, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__growl_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __growl_name, __cb);
        try
        {
            __result.__prepare(__growl_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
    ...
    public void end_growl(Ice.AsyncResult __result)
        throws WrongPasswordException
    {
        Ice.AsyncResult.__check(__result, this, __growl_name);
        if(!__result.__wait())
        {
            try
            {
    ...
    move(String password, float direction, float speed, int movementType)
        throws WrongPasswordException
    {
        move(password, direction, speed, movementType, null, false);
    }
    ...
    move(String password, float direction, float speed, int movementType, java.util.Map<String, String> __ctx)
        throws WrongPasswordException
    {
        move(password, direction, speed, movementType, __ctx, true);
    }

    private void
    move(String password, float direction, float speed, int movementType, java.util.Map<String, String> __ctx, boolean __explicitCtx)
        throws WrongPasswordException
    {
        if(__explicitCtx && __ctx == null)
        {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                __delBase = __getDelegate(false);
                _SpiderDel __del = (_SpiderDel)__delBase;
                __del.move(password, direction, speed, movementType, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    {
        return begin_move(password, direction, speed, movementType, null, false, null);
    }
    ...
    {
        return begin_move(password, direction, speed, movementType, __ctx, true, null);
    }

    public Ice.AsyncResult begin_move(String password, float direction, float speed, int movementType, Ice.Callback __cb)
    {
        return begin_move(password, direction, speed, movementType, null, false, __cb);
    }
    ...
    {
        return begin_move(password, direction, speed, movementType, __ctx, true, __cb);
    }
    ...
    private Ice.AsyncResult begin_move(String password, float direction, float speed, int movementType, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            catch(ClassCastException ex)
            {
                ...
                {
                    SpiderPrxHelper __h = new SpiderPrxHelper();
    ...
    __createDelegateM()
    {
        return new _SpiderDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _SpiderDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, SpiderPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            SpiderPrxHelper result = new SpiderPrxHelper();
