...
// <auto-generated>
//
// Generated from file `_AnimalLikeDisp.java'
//
...
public abstract class _AnimalLikeDisp extends Ice.ObjectImpl implements AnimalLike
{
    protected void
    ...
    ___growl(AnimalLike __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        try
        {
            __obj.growl(password, type, __current);
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 2:
            {
                return ___growl(this, in, __current);
            }
            case 3:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type blackmesa::testlab::devices::AnimalLike was not generated with stream support";
        throw ex;
    }
