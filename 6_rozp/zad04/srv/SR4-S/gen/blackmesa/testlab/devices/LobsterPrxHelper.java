...
// <auto-generated>
//
// Generated from file `LobsterPrxHelper.java'
//
...
public final class LobsterPrxHelper extends Ice.ObjectPrxHelperBase implements LobsterPrx
{
    public void
        ...
        throws WrongPasswordException
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _LobsterDel __del = (_LobsterDel)__delBase;
    ...
    public void
    move(String password, float direction, float speed)
        throws WrongPasswordException
    {
        move(password, direction, speed, null, false);
    }
    ...
    move(String password, float direction, float speed, java.util.Map<String, String> __ctx)
        throws WrongPasswordException
    {
        move(password, direction, speed, __ctx, true);
    }

    private void
    move(String password, float direction, float speed, java.util.Map<String, String> __ctx, boolean __explicitCtx)
        throws WrongPasswordException
    {
        if(__explicitCtx && __ctx == null)
        {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                __delBase = __getDelegate(false);
                _LobsterDel __del = (_LobsterDel)__delBase;
                __del.move(password, direction, speed, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    {
        return begin_move(password, direction, speed, __ctx, true, __cb);
    }
    ...
    private Ice.AsyncResult begin_move(String password, float direction, float speed, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            try
            {
                __d = (LobsterPrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    LobsterPrxHelper __h = new LobsterPrxHelper();
    ...
    public static final String[] __ids =
    {
        ...
        "::blackmesa::testlab::devices::Lobster"
    };
    ...
    __createDelegateM()
    {
        return new _LobsterDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _LobsterDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, LobsterPrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            LobsterPrxHelper result = new LobsterPrxHelper();
